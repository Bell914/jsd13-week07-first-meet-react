  ...
  return (
    <div className="flex flex-col items-center justify-center text-center my-6">
      <div className="relative inline-block group">
        {/* ชั้นเงาสีส้มอิฐด้านหลัง (Offset Brick Orange Box) */}
        <div className="absolute inset-0 bg-orange-600 translate-x-2.5 translate-y-2.5 rounded-sm transition-transform duration-300 group-hover:translate-x-3.5 group-hover:translate-y-3.5" />

        {/* Front Neon Green Box */}
